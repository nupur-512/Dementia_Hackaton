...
document.getElementById('doctorProfileForm').addEventListener('submit', function(event) {
    ...
    const specialization = specializationElement ? specializationElement.value : '';

    // Ensure all required fields are populated
    if (!registrationNo || !addressLine1 || !city || !postalCode || !qualification || !specialization || !identificationDoc) {
            ...
            if (doc.exists) {
                ...
                return storageRef.put(identificationDoc)
                    ...
                    .then((downloadURL) => {
                        ...
                        return db.collection('doctors').doc(user.uid).set({
                            firstName: firstName,
                            lastName: lastName,
                            email: user.email,
                    ...
                    .then(() => {
                        ...
                        window.location.href = 'doctor_dashbaord.html';
                    })
                    .catch((error) => {
